...
class NormalizedStr:
    ...
    *semantically*,
    ...
    def __repr__(self):
        ...
        code
        that can be substituted directly into the python interpreter to
    ...
    def __contains__(self, substr):
        ...
        return normal_substr in self.text
    ...
    def lower(self):
        ...
        '''
        lower_form = str(self.text).lower()
        return lower_form
    ...
    def upper(self):
        ...
        '''
        upper_form = str(self.text).upper()
        return upper_form
    ...
    def __add__(self, b):
        ...
        '''
        add = unicodedata.normalize(self.normal_form, self.text + str(b))
        return NormalizedStr(add)
