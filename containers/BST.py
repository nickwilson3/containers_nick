'''
This fil implements the Binary Search Tree data structure.
...
class BST(BinaryTree):
    ...
    def __eq__(self, t2):
        ...
        '''
        inorder_list_self = self.to_list('inorder')
        inorder_list_t2 = t2.to_list('inorder')
        return inorder_list_self == inorder_list_t2
